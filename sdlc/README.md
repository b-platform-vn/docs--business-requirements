...
| **Business Analyst**     | Product specs, acceptance criteria, FRDs, issue triage                                         | Long (An supports), Hải                                                                        |
| **Solution Architect**   | ADRs, repo topology, SOLID boundaries, work-breakdown plans                                    | Long, Hải                                                                                      |
