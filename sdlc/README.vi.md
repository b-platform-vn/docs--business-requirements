...
| **Business Analyst**     | Product spec, acceptance criteria, FRD, phân loại issue                                      | Long (An hỗ trợ), Hải                                                                          |
| **Solution Architect**   | ADR, topology repo, ranh giới SOLID, kế hoạch work-breakdown                                 | Long, Hải                                                                                      |
